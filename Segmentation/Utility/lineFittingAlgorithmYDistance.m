function [ inflection_points] = lineFittingAlgorithmYDistance( signal, threshold )
...
if length(signal) > 1
    ...
    if max_value > threshold && eligible == 1
        ...
        result_left = lineFittingAlgorithmYDistance(left_signal, threshold_left);
        result_right = lineFittingAlgorithmYDistance(right_signal, threshold_right);
